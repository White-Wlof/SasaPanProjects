...
IL_003e:
	{
		...
		int32_t L_11 = L_10;
		V_0 = ((int32_t)((int32_t)((L_6)->GetAt(static_cast<il2cpp_array_size_t>(L_8)))-(int32_t)((L_9)->GetAt(static_cast<il2cpp_array_size_t>(L_11)))));
		int32_t L_12 = V_0;
...
extern "C"  int32_t Random_Next_m2107657609 (Random_t922188920 * __this, const MethodInfo* method)
{
	{
		double L_0 = VirtFuncInvoker0< double >::Invoke(4 /* System.Double System.Random::Sample() */, __this);
		return (((int32_t)((int32_t)((double)((double)L_0*(double)(2147483647.0))))));
	}
}
...
extern "C"  int32_t Random_Next_m826342746 (Random_t922188920 * __this, int32_t ___maxValue, const MethodInfo* method)
{
	static bool s_Il2CppMethodIntialized;
	if (!s_Il2CppMethodIntialized)
	{
