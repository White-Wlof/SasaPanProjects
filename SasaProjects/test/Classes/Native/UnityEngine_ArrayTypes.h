...
// UnityEngine.GUIContent[]
struct GUIContentU5BU5D_t130836426  : public Il2CppArray
{
public:
	ALIGN_TYPE (8) GUIContent_t2432841515 * m_Items[1];

public:
	inline GUIContent_t2432841515 * GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline GUIContent_t2432841515 ** GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, GUIContent_t2432841515 * value)
	{
		m_Items[index] = value;
		Il2CppCodeGenWriteBarrier(m_Items + index, value);
	}
