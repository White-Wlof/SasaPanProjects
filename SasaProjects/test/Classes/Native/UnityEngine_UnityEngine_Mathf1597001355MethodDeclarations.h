...
extern "C"  float Mathf_SmoothDampAngle_m3226502443 (Il2CppObject * __this /* static, unused */, float ___current, float ___target, float* ___currentVelocity, float ___smoothTime, float ___maxSpeed, const MethodInfo* method) IL2CPP_METHOD_ATTR;
